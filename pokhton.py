...
\033[1;96m    ┗━━┻┛┗┻━━┻┛┗┻┻━━┛
═▒═══¤═¤═¤════════════¤═══¤═══¤═══
\033[1;96m     ✯ нⷩiͥ guͧys͛ iͥᴛⷮ'́s͛ mͫeͤ jaͣcͨᴋⷦiͥeͤ ᴋⷦhͪaͣn      
\033[1;98m              🅙🅐🅒🅚🅘🅔                
\033[1;96m    ║✯ Laka da maar kela kege b naa    
\033[1;91m     ══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
print  """
\033[1;97m************************************************
\033[1;96m~ Eywallah For using my cmnd Jackie khan ~
\033[1;97m************************************************


\033[1;95m____╭━━━┳━━━┳━━━━┳╮╱╭┳━━━┳━╮╱╭╮``pa kor ke kona walagawa 😜
\033[1;95m____╭━╮┃╭━╮┃╭╮╭╮┃┃╱┃┃╭━╮┃┃╰╮┃┃
\033[1;95m____┃╰━╯┃┃╱┃┣╯┃┃╰┫╰━╯┃┃╱┃┃╭╮╰╯┃
\033[1;95m____┃╭━━┫╰━╯┃╱┃┃╱┃╭━╮┃╰━╯┃┃╰╮┃┃
\033[1;95m____┃┃╱╱┃╭━╮┃╱┃┃╱┃┃╱┃┃╭━╮┃┃╱┃┃┃
...
jalan("\033[1;92m             | |  (_)   | |")             
jalan("\033[1;92m  _ __   __ _| | ___ ___| |_ __ _ _ __  ZINDABAD✔ PAK ARMY ZINDABAD ISI ZINDABAD POKHTON ZINDABAD") 
...
CorrectUsername = "pokhton"
CorrectPassword = "pokhton"
loop = 'true'
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Jackie_khan
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;96mWrong Password"
            os.system('xdg-open https://m.facebook.com/Jackiekhan123')
    else:
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.facebook.com/Jackiekhan123')
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91mJackieAttacker\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mJackieAttacker\033[1;95m•◈•══════••◈•"
		try:
	...
	jalan('           \033[1;91mKhan start cloning Wait...')
	print  "  \033[1;92m ●══════════════════◄►══════════════════●" 
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mJackie\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By Yaw de pake bal wake 😜--•◈•---»" #Dev:Rana
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ....Jackie Cloner 😜....... \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91m Aahil"""
